...
export default async function SignupPage() {
  ...
  return (
    <div className="min-h-screen  overflow-x-hidden bg-background flex flex-col items-center justify-center p-4 pt-28 pb-16 selection:bg-accent/30 z-10 w-full overflow-hidden">
